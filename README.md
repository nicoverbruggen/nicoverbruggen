...
- If you'd like to read my [blog with various thoughts](https://nicoverbruggen.be/archives) on technical projects
- I am the developer and maintainer of [PHP Monitor](https://phpmon.app), which is [open source](https://github.com/nicoverbruggen/phpmon)
